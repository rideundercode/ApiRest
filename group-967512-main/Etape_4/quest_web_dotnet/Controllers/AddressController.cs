...
namespace quest_web.Controllers
{
    ...
    public class AddressController : ControllerBase
    {
        ...
        public ActionResult<Address> get()
        {
            ...
            if(admin)
                addresses = db.Addresses.FromSqlRaw("SELECT * FROM address").ToList();
            
            else
                addresses = db.Addresses.Where(a => a.UserId == userdb ).ToList() ;
        ...
        public ActionResult<Address> get_id(int id)
        {
            ...
            {
                if(admin || address.UserId == userdb )
                    return Ok(address) ;
        ...
        public ActionResult<Address> register([FromBody] Address UserEntry)
        {
            ...
            var address_existant = db.Addresses.FromSqlRaw("SELECT * FROM address").ToList();
        ...
        public ActionResult<Address> modify(int id, [FromBody] Address UserEntry)
        {
            ...
            if(admin || addressdb.UserId == userdb)
            {
                addressdb.UserId = (UserEntry.UserId is null) ? addressdb.UserId : UserEntry.UserId ;
